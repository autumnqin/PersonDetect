  ...
  with slim.arg_scope([slim.ops.conv2d, slim.ops.fc], weight_decay=0.00004):
    with slim.arg_scope([slim.ops.conv2d],
      ...
      with slim.arg_scope([slim.variables.variable], device='/cpu:0'):
        logits, endpoints = slim.pvanet.pvanet_v3(
            images,
...
def pvanet_v3_parameters(weight_decay=0.00004, stddev=0.1,
                            batch_norm_decay=0.9997, batch_norm_epsilon=0.001):
  """Yields the scope with the default parameters for pvanet_v3.
  ...
  Yields:
    a arg_scope with the parameters needed for pvanet_v3.
  """
  # Set weight_decay for weights in Conv and FC layers.
